...
<template>
    <NuxtLayout name="app-section" class="search-result-section mb-[34px]">
        <template #head>
            <div class="sm:flex sm:items-center sm:justify-between flex-wrap relative z-10 mb-[18px]">
                <p class="text-center text-[26px] leading-9 font-bold text-[#131313] font-[Raleway] mb-4 sm:mb-0">Вам подойдет</p>
                ...
                <div class="relative filter-btn w-full" onclick="() => toggle()">
                    <button class="h-11 flex w-full items-center justify-between text-gray-900 border-2 border-[#f8f8f8] rounded-[5px] px-4">
                        <p class="text-[13px] font-[Raleway] font-extralight leading-4 italic">Сортировать по:</p>
        ...
        <div class="buildings grid grid-cols-12 gap-3 mb-[2px]">
            <!-- 26 + 2 = 28 -->

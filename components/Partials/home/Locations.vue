...
<template>
    <app-width class="locations-section overflow-hidden rounded-[5px] md:p-0 lg:w-9/12 md:mx-auto mb-[42px] md:mb-[180px] pr-5 md:pr-[60px]" :padding="false">
        <div class="md:flex md:flex-row-reverse md:items-stretch md:justify-center">
            ...
            <div class="images md:w-1/2 md:p-9 pb-[15px]">
                <!-- <app-img :src="Couple" /> -->

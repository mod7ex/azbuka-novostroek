...
<template>
    <div :class="[$attrs.class, 'bg-[#E1F1FF] rounded-[3px] pt-[33px] px-[29px] md:pt-[38px] md:px-[46px] pb-[31px] md:pb-[25px] text-center promotion', 'md:flex md:items-center md:justify-between md:flex-row-reverse']">
        <div :class="['font-[Inter] mb-[30px]', 'md:hidden']">
            <h2 class="font-bold text-xl leading-[30px]">Акции от застройщика</h2>

            <h1 class="text-[#3478F6] font-bold text-xl leading-[30px] mb-[10px]">{{ discount?.title }}</h1>
        ...
        <div>
            <div class="font-[Inter] mb-[41px] hidden md:block text-left">
                ...
                <h1 class="text-[#3478F6] font-bold text-[22px] leading-[26px] mb-[11px]">{{ discount?.title }}</h1>
